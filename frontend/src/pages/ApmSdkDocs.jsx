      ...
      <div className="grid min-h-[calc(100vh-3.5rem)] grid-cols-1 lg:grid-cols-[240px_minmax(0,1fr)] xl:grid-cols-[240px_minmax(0,1fr)_minmax(320px,36vw)]">
        ...
        <main className="min-w-0 px-5 py-8 sm:px-8 lg:px-10">
          ...
          <DocSection id="configuration" title="Configuration">
            ...
            <DefinitionTable
              rows={[
                ...
                ['APM_INGEST_RATE_LIMIT', 'Server-side limit per API key per 60-second window. Default: 60.'],
              ]}
            />
          </DocSection>
          ...
          <DocSection id="payload" title="Payload Format">
            ...
            <DefinitionTable
              rows={[
                ...
                ['error_message', 'Optional error detail for 4xx/5xx requests. Truncated to 2000 characters.'],
              ]}
            />
          </DocSection>
          ...
          <DocSection id="rate-limits" title="Rate Limits">
            ...
            <DefinitionTable
              rows={[
                ['X-RateLimit-Limit', 'Maximum ingest requests allowed in the current 60-second window.'],
                ['X-RateLimit-Remaining', 'Requests remaining in the current window.'],
                ['X-RateLimit-Window', 'Rate limit window size in seconds.'],
              ]}
            />
          </DocSection>
